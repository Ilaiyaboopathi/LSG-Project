...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <!-- FormValidation -->
            <?php if ($SettingAddDesignation === 'Enable') : ?>
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-6 d-flex justify-content-end mt-12">
                                                ...
                                                <button type="submit" id="submit"
                                                    value="<?php echo ($buttonText === 'Update') ? 'UpdateDesignation' : 'AddDesignation'; ?>"
    ...
    <?php if ($SettingDesignationView === 'Enable') : ?>
        <div class="row" style="margin-top: 50px;">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-datatable table-responsive">
                            <table class="data_tables_designation table">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>S.No</th>
...
<script src="assets/js/designaiton.js"></script>
    ...
    $('#designation_add').on('submit', function(e) {
        ...
        fetch('function.php', {
            ...
            .then(result => {
                ...
                $('#SameNameAlert').show();
                            $('#Same_name_alert_para').html('Designation name is already exist');
